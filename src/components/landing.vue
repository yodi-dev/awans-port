...
<template>
  <main class="container-lg mt-5">
    <div class="row justify-content-lg-end">
      <div class="col-lg-8 g-0 text-end">
        <h1 class="display-2 fw-semibold">
          Welcome to <br />
          My Portfolio
        </h1>
        <p class="text-end fw-light">
          I'm Awan, a passionate Full Stack Web Developer dedicated to crafting
          dynamic and responsive web applications. I thrive on tackling coding
          challenges and constantly expanding my knowledge to bring innovative
